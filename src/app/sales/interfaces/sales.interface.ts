...
export class Convert {
    public static toSalesResponse(json: string): SalesResponse[] {
        return cast(JSON.parse(json), a(r("SalesResponse")));
    }

    public static salesResponseToJson(value: SalesResponse[]): string {
        return JSON.stringify(uncast(value, a(r("SalesResponse"))), null, 2);
    }
}
